...
const mcqQuestions = [
  ...
  // DBMS (6 questions)
  {
    ...
    options: ['Atomicity, Consistency, Isolation, Durability', 'Access, Control, Integrity, Data', 'Application, Communication, Integration, Database', 'None of the above'],
  ...
  },
  {
    ...
    options: ['Data corruption', 'Two or more transactions waiting for each other', 'Database shutdown', 'Connection timeout'],
  ...
  },
  {
    ...
    options: ['Same method name with different parameters', 'Redefining parent method in child', 'Multiple inheritance', 'Static method'],
  ...
  },
  {
    ...
    options: ['Multiple forms of a method', 'Multiple classes', 'Multiple objects', 'Multiple inheritance'],
  ...
  {
    classification: 'Object-Oriented Programming',
    question: 'Which access modifier makes a member accessible only within the class?',
  ...
  },
  {
    ...
    options: ['A class that cannot be instantiated', 'A class with no methods', 'A final class', 'A static class'],
  ...
  // Operating Systems (6 questions)
  {
    ...
    options: ['Compile programs', 'Manage resources', 'Create applications', 'Design hardware'],
  ...
  },
  {
    ...
    options: ['Process termination', 'Circular wait condition', 'Memory leak', 'CPU idle time'],
  ...
  },
  {
    ...
    options: ['Domain Name System', 'Dynamic Network Service', 'Data Network System', 'Digital Name Service'],
