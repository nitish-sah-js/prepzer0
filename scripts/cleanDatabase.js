...
const cleanDatabase = async () => {
  try {
    ...
    console.log(
      "❌ DELETING: Students, Submissions, Exams, Activity Trackers, Exam Candidates, Integrity records\n"
    )
    ...
    try {
      ...
      console.log(
        `   ✅ Deleted ${results.evaluationResults} evaluation results`
      )
    } catch (error) {
      console.log(
        `   ⚠️  Evaluation Results model not found or already deleted`
      )
    }
    ...
    try {
      const CodingQuestion =
        ...
        require("../models/CodingQuestionSchema")
